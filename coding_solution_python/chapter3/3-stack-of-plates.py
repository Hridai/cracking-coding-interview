"""
Problem:
Imagine a (literal) stack of plates. If the stack gets too tall, we might
topple it. In real life, we would likely start a new stack when the previous
...
FOLLOW UP: Implement a function popAt(index) which performs a pop operation
